...
export default function AppView({
	...
	unlocked: boolean, noteCount: boolean
}) {
  ...
  const tabs = [
        ...
        if (unlocked) {
          ...
          alert("Uploading files and URLs is a paid feature. Please pay to unlock all features.")
        }
      },
		},
	]
  ...
  const startRecording = async () => {
    if (unlocked || noteCount) {
      ...
      alert("You have exceeded the number of notes. Please pay to unlock all features.")
    }
  };
